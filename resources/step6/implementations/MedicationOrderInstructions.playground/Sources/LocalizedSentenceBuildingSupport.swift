...
public protocol LocalizedSentenceBuildingSupport {
...
extension LocalizedSentenceBuildingSupport {
    public static var optionalFormatStrings: [String] {
        var result = allFormatStrings
        result.append("")
        return result
    }
}
