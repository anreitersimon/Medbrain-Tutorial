...
extension SequenceType where Self.Generator.Element: SequenceType {
    var combinations: Combinations<Generator.Element.Generator.Element> {
        return Combinations(self.map ({ $0 }))
    }
}

struct Combinations<T>: SequenceType {
